...
// if user logged in then customer wishlist number appear 
...
// making title ,metatitle ,keyword ,description daynamic

$script_name=$_SERVER['SCRIPT_NAME'];
$script_name_arr=explode('/',$script_name);
$mypage=$script_name_arr[count($script_name_arr)-1];

$meta_title="Asbab Furniture";
$meta_desc="Asbab Furniture";
$meta_keyword="Asbab Furniture";
...
else if($mypage=='categories.php'){
    $meta_title='Catogories';
}
