...
//checking if we have added already not added in database
 ...
 //if product is not already added in the wishlist then execute else block 
// in this block it will insert data so i m passing the parameters to the function
